...
public void testGetConfigImplRegistry()
{
	...
	assertThat( configImplRegistry.get( "KLoK" ), is( new KLoK() ) );
	...
	assertThat( configImplRegistry.get( "TestKLoK" ), is( new TestKLoK() ) );
	...
	assertThat( configImplRegistry.get( "PipoKLoK" ), is( new PipoKLoK() ) );
