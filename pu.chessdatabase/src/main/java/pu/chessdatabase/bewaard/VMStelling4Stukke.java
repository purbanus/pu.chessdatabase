...
@NoArgsConstructor
@AllArgsConstructor
public class VMStelling4Stukke extends VMStelling implements Cloneable
{
public static class AlfaBuilder
{
private VMStelling4Stukke vmStelling = new VMStelling4Stukke();
...
public VMStelling4Stukke build()
{
	return vmStelling;
}
}
